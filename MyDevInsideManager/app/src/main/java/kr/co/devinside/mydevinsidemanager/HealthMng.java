package kr.co.devinside.mydevinsidemanager;
...
public class HealthMng extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        URL_SEARCH = "http://www.devinside.co.kr/Android/HealthMng.aspx?USERID=admin&DATE=%s";
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                URL_KIND = "UPDATE";
                URL_UPDATE = "http://www.devinside.co.kr/Android/HealthMng_Update.aspx?DATE=%s";
                ...
                mProgress = ProgressDialog.show(HealthMng.this, "저장", "저장중입니다...");
